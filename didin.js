...
*Silahkan* @${m.mentionedJid[0].split`@`[0]} *untuk ketik terima/tolak*`
            ...
            break
            case 'skdkka': {
                m.reply('https://wa.me/6285725766522')
            }
            break
            case 'bot': {
            ...
            break
            case 'groupbot': {
                m.reply('Halo Kak\nGroup DidinBotz: https://chat.whatsapp.com/HEV25AfOnaJ6c59TKyNdGM\nNOTE : Bantu Support Channelnya Ya\n\n*_Makasih><_*')
            }
            break
            case 'tqto': {
                m.reply('THANK TO :\nAll: :)')
...
buffer = global.thumb
  	anu = `*Hai Kak ${pushname}\nSaya Vellyan-Bot Saya Siap Membantu Kamu Kak.`
let buttons = [{ buttonId: 'tesrow', buttonText: { displayText: 'LIST MENU' }, type: 1 },{ buttonId: 'rules', buttonText: { displayText: 'RULES' }, type: 1 },{ buttonId: 'owner', buttonText: { displayText: 'OTHER' }, type: 1 }]
    didin.sendMessage(m.chat, { caption: `${anu}`, location: { jpegThumbnail: await reSize(buffer, 200, 200) }, buttons: buttons, footer:  `By: GtGnzz`, mentions: [m.sender] })
}
break
case 'rules': {
const Jimp = require('jimp')
...
let sections = [
                ...
                rows: [
{title: " ➽ 💌 ᴏᴡɴᴇʀ ‹", rowId: `owner`, description: `ʀᴏᴏᴍ ᴅᴇᴠᴇʟᴏᴘᴇʀ><`},
{title: " ➽ ☄️ ʀᴇǫᴜᴇsᴛ ‹", rowId: `request`, description: `ʀᴇǫᴜᴇsᴛ ғɪᴛᴜʀ ᴍᴇɴᴀʀɪᴋ ᴋᴇ ʙᴏᴛ`},
{title: " ➽ 📩 ʀᴇᴘᴏʀᴛ ‹", rowId: `report`, description: `ᴊɪᴋᴀ ᴀɴᴅᴀ ᴍᴇɴᴇᴍᴜᴋᴀɴ ʙᴜɢ/ᴇʀᴏʀ ʟᴀᴘᴏʀ ᴋᴇ ᴏᴡɴᴇʀ`},
{title: " ➽ 💻 ʙᴏᴛ sᴛᴀᴛᴜs ‹", rowId: `botinfo`, description: `ᴍᴇɴᴀᴍᴘɪʟᴋᴀɴ sᴛᴀᴛᴜs`},
]
},
  {
title: "Berikut Fitur Vellyan-Bot",
rows: [
...
title: "ɪɴғᴏ",
rows: [
{title: " ➽ 🔭 sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ", rowId: `sc`, description: `sᴄʀɪᴘᴛ`},
{title: " ➽ 💰 ᴅᴏɴᴀsɪ", rowId: `donasi`, description: `ᴅᴏɴᴀsɪ ʙᴀɴɢ ʙɪᴀʀ ʙᴏᴛ ᴏɴ 24 ᴊᴀᴍ`},
{title: " ➽ ❗ ʀᴜʟᴇs", rowId: `rules`, description: `ᴘᴇʀᴀᴛᴜʀᴀɴ ᴍᴇɴɢɢᴜɴᴀᴋᴀɴ Vellyan-Bot`},
{title: " ➽ 🥇 ᴄᴏɴᴛʀɪʙᴜᴛᴏʀ", rowId: `tqto`, description: `ʏᴀɴɢ ᴍᴇᴍʙᴀɴᴛᴜ ᴍᴇɴɢᴇᴍʙᴀɴɢᴋᴀɴ Vellyan-Bot`},
{title: " ➽ 🌸 ɢʀᴏᴜᴘ ʙᴏᴛ", rowId: `groupbot`, description: `ᴊᴀɴɢᴀɴ ʟᴜᴘᴀ ᴊᴏɪɴ ᴋᴀᴡᴀɴ`},
     ]
    }     
    ]

didin.sendListMsg(m.chat, `*_Hai kak ${pushname} ${ucapanWaktu}_*\n\n_Aku Vellyan-Bot Bot whatsapp multi-device yang dapat membantumu_*`, '', '', `Click Here!`, sections, m)
}
break
case 'gamemenu':{
  // send a list message!
  ...
  const listMessage = {
   text: `*_Hai kak ${pushname} ${ucapanWaktu}_*\n\n_Berikut Game" Yang Tersedia Di Vellyan-Bot`,
   footer: "Vellyan-Bot",
   title: "",
   buttonText: "Buka!",
   sections
...
let sections = [
                ...
                didin.sendListMsg(m.chat, `*❏ GtGnzz*
